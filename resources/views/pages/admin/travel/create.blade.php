...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
            {{-- <a class="btn btn-primary" href="{{ route('travels.update') }}"> Back</a> --}}
        </div>
    </div>
</div>
...
{!! Form::open(array('route' => 'travels.store','method'=>'POST')) !!}
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group m-2">
            ...
            {!! Form::text('depart_date', null, array('placeholder' => 'Departure Date','class' => 'form-control')) !!}
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
            <a class="btn btn-primary" href="{{ route('travel.index') }}"> Back</a>
        </div>
    </div>
</div>
